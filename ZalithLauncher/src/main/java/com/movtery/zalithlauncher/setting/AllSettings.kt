...
class AllSettings {
    companion object {
        ...
        @JvmStatic
        val gameMenuLocation = StringSettingUnit("gameMenuLocation", "right_or_bottom")
        ...
        @JvmStatic
        val launcherTheme = StringSettingUnit("launcherTheme", "dark")
        ...
        @JvmStatic
        val defaultRuntime = StringSettingUnit("defaultRuntime", "Internal-17")
